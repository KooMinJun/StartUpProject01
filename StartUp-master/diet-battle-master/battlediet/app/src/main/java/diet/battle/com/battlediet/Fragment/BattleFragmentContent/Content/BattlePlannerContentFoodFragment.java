...
public class BattlePlannerContentFoodFragment extends Fragment {
    CustomViewPager customViewPager;
    ImageView btn_arr[] = new ImageView[6];
    SharedPreferenceManager sharedPreferenceManager;
    int i;
    public BattlePlannerContentFoodFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_battle_planner_content_food, container, false);
